...
> **AI usage transparency:** generative AI tools were used to assist with drafting and structuring this README, sanitizing the public copy, and translating the documentation into English. Responsibility for technical review, decisions, and published content remains with the project author.
